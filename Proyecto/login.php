...
if(isset($_POST['submit'])){
	...
	$consulta= "SELECT id FROM usuarios WHERE email = '$email' and password = '$password'";
...
<body>
		...
		<main>
			<div class="login-cont">
				...
				<img class="avatar" src="img/icons8-huella-de-perro-40.png" alt="">
				...
				<div>
					<a class="linkend" href="register.php">¿No tienes cuenta? Create una ahora.</a>
				</div>
			</div>
		</main>
		<footer>
